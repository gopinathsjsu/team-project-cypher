    ...
    <div className="flex min-h-screen flex-col gap-4 bg-gray-900 pb-8 text-gray-900 sm:gap-8">
      ...
      {selectedCinemaIndex !== null &&
        (cinemas[selectedCinemaIndex]?.theaters?.length ? (
          <div className="mx-4 flex flex-col gap-2 rounded-lg bg-slate-400 p-4 drop-shadow-xl sm:mx-8 sm:gap-4 sm:p-6">
            ...
            {auth.role === "admin" && (
              <form
                className="flex flex-col lg:flex-row gap-4 rounded-md bg-gradient-to-br from-indigo-200 to-indigo-200 p-4"
                ...
                <div className="flex grow flex-col gap-2 rounded-lg">
                  <div className="flex flex-col gap-2 rounded-lg lg:flex-row lg:items-stretch">
                    ...
                    <div className="flex grow-[2] items-center gap-x-2 gap-y-1 lg:flex-col lg:items-start">
                      ...
                      <Select
                        onValueChange={(movie) => handleMovieSelect(movie)}>
                        <SelectTrigger>
