  ...
  const menuLists = () => {
    return (
      <>
        ...
        <div className="flex grow items-center justify-center gap-6 lg:justify-end">
          {auth.reward_points !== null && (
            <>
              <div className="flex items-center gap-4">
                <div className="h-10 w-12 flex items-center justify-center font-bold text-white bg-gold-500 rounded-lg">
          ...
          {auth.username && (
            <p className="text-md whitespace-nowrap leading-none text-white">
              {auth.membership && (
                <span
                  className={`font-bold rounded-full px-2 py-1 ${
